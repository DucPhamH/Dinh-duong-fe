          ...
          <div className='grid grid-cols-12 gap-1'>
            <div className='relative my-6 px-8 col-span-12 sm:col-span-12 md:col-span-7 lg:col-span-7 2xl:col-span-7'>
              <div className='border-l-4 border-gray-400 py-20 px-5 mx-2 absolute left-0'>
                <p className='italic line-clamp-1 md:line-clamp-2 text-white text-xl md:text-4xl lg:text-6xl  text-center font-semibold '>
                  {product.title}
                </p>
              </div>
            ...
            <div className='col-span-12 pt-24 sm:col-span-12 md:col-span-5 md:pt-0 lg:col-span-5 xxl:col-span-5'>
              <div className='relative bg-pink-900 h-full md:h-96 w-full bg-opacity-50 rounded-tr-lg rounded-br-lg'>
                <div className='p-10'>
                  <p className='text-white md:line-clamp-5 lg:line-clamp-6 line-clamp-4 text-base md:text-lg lg:text-2xl mb-10'>
                    {product.content}
                  </p>
                  <div className=' bottom-0 absolute  right-0'>
                    <button
                      onClick={() => navigate(`/kien-thuc/${product.id}`)}
                      className='border-2 hover:shadow-xl shadow-lg transition-all ease-in duration-400 hover:scale-105 border-white px-6 py-4 lg:m-4 text-xl font-medium text-center text-white rounded-lg hover:bg-white hover:text-black focus:ring-4 focus:outline-none'
                    >
                      <span>Đọc tiếp</span>
                    </button>
                  </div>
