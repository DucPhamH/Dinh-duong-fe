...
function Navbar({ activeMenu }) {
  ...
  return (
    ...
    >
      <ul className='flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-16 lg:md:-x-8'>
        {listItems.map((item) => {
          return (
            <li key={item.id} className='text-xl z-1000 md:text-xl lg:text-2xl font-semibold group '>
