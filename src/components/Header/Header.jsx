    ...
    <div className='w-full top-0 fixed z-10 text-gray-900 '>
      ...
      <div className='flex items-center pt-4 pb-8 px-8 mx-auto max-w-screen-xl justify-between md:px-4'>
        ...
        <div className='flex justify-center items-center'>
          <ShoppingCart />
          {/* <UserAvatar /> */}
          <button class='relative inline-flex items-center justify-center p-0.5 mr-4 overflow-hidden text-xl font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-red-200 via-red-300 to-yellow-200 group-hover:from-red-200 group-hover:via-red-300 group-hover:to-yellow-200'>
