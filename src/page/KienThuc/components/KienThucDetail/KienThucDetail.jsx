...
export default function KienThucDetail() {
  ...
  console.log(product)
  return (
    <div className='text-black flex justify-center lg:bg-[#f1fbff] h-full pb-40 '>
      {product && (
        <>
          <div className='w-[90%] lg:w-[65%] bg-white shadow-lg rounded-sm p-10 mt-10 '>
            ...
            <div className='flex justify-center py-10  w-full overflow-hidden bg-cover'>
              <img className='lg:w-[80%] lg:h-[34rem] object-cover rounded-md' src={product.image} alt='' />
            </div>
            <div
